...
public class MenuItemsMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JButton buscarItemsMenu = new JButton();
        JButton botonEditarItemsMenu = new JButton();
        JButton botonEliminarItemsMenu = new JButton();
        JButton botonCrearItemsMenu = new JButton();
        campoNombre = new javax.swing.JTextField();
        JLabel tit1 = new JLabel();
        campoDireccion = new javax.swing.JTextField();
        JLabel tit2 = new JLabel();
        JLabel tit3 = new JLabel();
        JScrollPane scrollTablaItemsMenu = new JScrollPane();
        tablaItemsMenu = new javax.swing.JTable();
        campoPrecio = new javax.swing.JTextField();
        JLabel tit5 = new JLabel();
        JLabel tit4 = new JLabel();
        ...
        buscarItemsMenu.setFont(new java.awt.Font("Times New Roman", Font.PLAIN, 12)); // NOI18N
        buscarItemsMenu.setForeground(new java.awt.Color(255, 255, 255));
        buscarItemsMenu.setText("BUSCAR ITEMS MENÚ");
        buscarItemsMenu.addActionListener(this::buscarItemsMenuActionPerformed);

        botonEditarItemsMenu.setBackground(new java.awt.Color(123, 36, 28));
        botonEditarItemsMenu.setFont(new java.awt.Font("Times New Roman", Font.PLAIN, 12)); // NOI18N
        botonEditarItemsMenu.setForeground(new java.awt.Color(255, 255, 255));
        botonEditarItemsMenu.setText("EDITAR ITEMS MENÚ");
        botonEditarItemsMenu.addActionListener(this::botonEditarItemsMenuActionPerformed);

        botonEliminarItemsMenu.setBackground(new java.awt.Color(123, 36, 28));
        botonEliminarItemsMenu.setFont(new java.awt.Font("Times New Roman", Font.PLAIN, 12)); // NOI18N
        botonEliminarItemsMenu.setForeground(new java.awt.Color(255, 255, 255));
        botonEliminarItemsMenu.setText("ELIMINAR ITEMS MENÚ");
        botonEliminarItemsMenu.addActionListener(this::botonEliminarItemsMenuActionPerformed);

        botonCrearItemsMenu.setBackground(new java.awt.Color(123, 36, 28));
        botonCrearItemsMenu.setFont(new java.awt.Font("Times New Roman", Font.PLAIN, 12)); // NOI18N
        botonCrearItemsMenu.setForeground(new java.awt.Color(255, 255, 255));
        botonCrearItemsMenu.setText("CREAR ITEMS MENÚ");
        botonCrearItemsMenu.addActionListener(this::botonCrearItemsMenuActionPerformed);
        ...
        campoDireccion.setFont(new java.awt.Font("Times New Roman", Font.PLAIN, 20)); // NOI18N
        ...
        campoVendedor.setFont(new java.awt.Font("Times New Roman", Font.PLAIN, 20)); // NOI18N
    ...
    private void botonEditarItemsMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEditarItemsMenuActionPerformed
        ...
        if (filaSeleccionada != -1) {
            try {
                ...
                // Verificar el tipo de ItemMenu
                if (item instanceof Plato) {
                    Plato datosPlato = itemMenuController.obtenerDatosPlato(id);
                    ((Plato) item).setPeso(datosPlato.getPeso());
                    ((Plato) item).setCalorias(datosPlato.getCalorias());
                    ((Plato) item).setAptoVegano(datosPlato.isAptoVegano());
                } else if (item instanceof Bebida) {
                    Bebida datosBebida = itemMenuController.obtenerDatosBebida(id);
                    ((Bebida) item).setTamanio(datosBebida.getTamanio());
                    ((Bebida) item).setBebidaAlcoholica(datosBebida.isBebidaAlcoholica());
                }

                // Abrir ventana de edición con los datos completos
                VentanaDeCreacionEdicionItemsMenu nuevaVentana = new VentanaDeCreacionEdicionItemsMenu(itemMenuController, vendedorController);
                nuevaVentana.setVisible(true);
                nuevaVentana.setLocationRelativeTo(null);
    ...
    private void buscarItemsMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarItemsMenuActionPerformed
        try {
            ...
            String categoriaBuscado = Objects.requireNonNull(comboBoxCategoria.getSelectedItem()).toString().toLowerCase();
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MenuItemsMenu(itemMenuController, vendedorController).setVisible(true));
    }
